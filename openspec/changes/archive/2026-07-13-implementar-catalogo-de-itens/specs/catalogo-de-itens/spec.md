...
A interface SHALL exibir os itens com seu título e tipo, e SHALL permitir filtro por tipo e busca textual.

#### Scenario: Filtrar itens por tipo

- **WHEN** o operador selecionar o tipo "Canto" no filtro
- **THEN** o sistema SHALL exibir apenas os ItemColetanea do tipo Canto
